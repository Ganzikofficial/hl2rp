...
Schema.voices.Add("Combine", "0", "Ноль.", "npc/metropolice/vo/zero.wav")
Schema.voices.Add("Combine", "1", "Один.", "npc/metropolice/vo/one.wav")
Schema.voices.Add("Combine", "10", "Десять.", "npc/metropolice/vo/ten.wav")
Schema.voices.Add("Combine", "10-0 ОХОТА", "10-0, 10-0, viscerator is hunting!", "npc/metropolice/vo/tenzerovisceratorishunting.wav")
Schema.voices.Add("Combine", "100", "Сто.", "npc/metropolice/vo/onehundred.wav")
Schema.voices.Add("Combine", "10-103 TAG", "Возможные 10-103, мое местоположение, предупреждать TAG единицы.", "npc/metropolice/vo/possible10-103alerttagunits.wav")
Schema.voices.Add("Combine", "10-107", "У меня есть 10-107, отправьте AirWatch для тега.", "npc/metropolice/vo/gota10-107sendairwatch.wav")
Schema.voices.Add("Combine", "10-108", "У нас есть 10-108!", "npc/metropolice/vo/wehavea10-108.wav")
Schema.voices.Add("Combine", "10-14", "Дежурство 10-14, а, код четыре.", "npc/metropolice/vo/holdingon10-14duty.wav")
Schema.voices.Add("Combine", "10-15", "Подготовиться к 10-15.", "npc/metropolice/vo/preparefor1015.wav")
Schema.voices.Add("Combine", "10-2", "10-2.", "npc/metropolice/vo/ten2.wav")
Schema.voices.Add("Combine", "10-25", "Любой объект, сообщить о 10-25 как подозреваемом.", "npc/metropolice/vo/unitreportinwith10-25suspect.wav")
Schema.voices.Add("Combine", "10-30", "У меня 10-30, у меня 10-20, отвечает, код два.", "npc/metropolice/vo/Ihave10-30my10-20responding.wav")
Schema.voices.Add("Combine", "10-4", "10-4.", "npc/metropolice/vo/ten4.wav")
Schema.voices.Add("Combine", "10-65", "Офицер 10-65.", "npc/metropolice/vo/unitis10-65.wav")
Schema.voices.Add("Combine", "10-78", "Диспетчерская, мне нужно 10-78, у офицера проблемы!", "npc/metropolice/vo/dispatchIneed10-78.wav")
Schema.voices.Add("Combine", "10-8 standing by", "10-8 в режиме ожидания.", "npc/metropolice/vo/ten8standingby.wav")
Schema.voices.Add("Combine", "10-8", "Объект дежурный, 10-8.", "npc/metropolice/vo/unitisonduty10-8.wav")
Schema.voices.Add("Combine", "10-91D", "10-91d количество...", "npc/metropolice/vo/ten91dcountis.wav")
Schema.voices.Add("Combine", "10-97 GOA", "10-97, подозреваемый GOA.", "npc/metropolice/vo/ten97suspectisgoa.wav")
Schema.voices.Add("Combine", "10-97", "10-97.", "npc/metropolice/vo/ten97.wav")
Schema.voices.Add("Combine", "10-99", "Офицер убит, я 10-99, я повторяю, я 10-99!", "npc/metropolice/vo/officerdownIam10-99.wav")
...
Schema.voices.Add("Combine", "11-6", "Подозреваемый 11-6, мои 10-20 это...", "npc/metropolice/vo/suspect11-6my1020is.wav")
Schema.voices.Add("Combine", "11-99", "11-99, офицер требует помощи!", "npc/metropolice/vo/11-99officerneedsassistance.wav")
Schema.voices.Add("Combine", "2", "Два.", "npc/metropolice/vo/two.wav")
Schema.voices.Add("Combine", "20", "Двадцать.", "npc/metropolice/vo/twenty.wav")
Schema.voices.Add("Combine", "200", "Тве тысячи.", "npc/metropolice/vo/twohundred.wav")
Schema.voices.Add("Combine", "3", "Три.", "npc/metropolice/vo/three.wav")
Schema.voices.Add("Combine", "30", "Тридцать.", "npc/metropolice/vo/thirty.wav")
Schema.voices.Add("Combine", "300", "Три сотни.", "npc/metropolice/vo/threehundred.wav")
