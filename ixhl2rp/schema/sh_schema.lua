...
Schema.description = "Схема основанная по вселенной Half-Life 2."
...
ix.anim.SetModelClass("models/cppackredux/eliteconceptunits/c_elite_red.mdl", "metrocop")
ix.anim.SetModelClass("models/cppackredux/eliteunits/elite_red.mdl", "metrocop")
ix.anim.SetModelClass("models/red_arrows/extremist_soldier_snow_balaclava.mdl", "citizen_male")
...
do
	...
	CLASS.format = "%s говорит в радио \"%s\""
