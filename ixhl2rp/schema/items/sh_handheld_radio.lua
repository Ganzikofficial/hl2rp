...
ITEM.name = "Портативная рация"
ITEM.model = Model("models/citizen_radio.mdl")
ITEM.description = "Портативная рация с настраиваемой частотой.\nСейчас она %s%s."
ITEM.cost = 65
...
function ITEM:GetDescription()
	...
	return string.format(self.description, enabled and "включена" or "выключена", enabled and (" и настроена на " .. self:GetData("frequency", "100.0")) or "")
end
